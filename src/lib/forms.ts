...
export const slyderApplicationSchema = z.object({
  ...
  vehicle: z.object({
    make: nonEmpty("Vehicle make is required"),
    model: nonEmpty("Vehicle model is required"),
    year: nonEmpty("Vehicle year is required"),
    color: nonEmpty("Vehicle colour is required"),
    plateNumber: z.string().trim().optional().default(""),
    registrationExpiry: nonEmpty("Registration expiry date is required"),
    insuranceExpiry: nonEmpty("Insurance expiry date is required"),
    fitnessExpiry: nonEmpty("Fitness certificate expiry date is required"),
  }),
