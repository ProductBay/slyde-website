...
export function HomeWalletBanner() {
  return (
    <section className="section-shell py-6">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[linear-gradient(135deg,rgba(248,190,74,0.95)_0%,rgba(162,90,255,0.9)_34%,rgba(14,165,233,0.88)_66%,rgba(248,190,74,0.95)_100%)] p-[1px] shadow-[0_28px_90px_rgba(15,23,42,0.22)]">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,245,208,0.85),transparent_22%),radial-gradient(circle_at_top_right,rgba(206,147,255,0.45),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(56,189,248,0.28),transparent_22%),radial-gradient(circle_at_bottom_right,rgba(250,204,21,0.22),transparent_18%)]" />
        ...
        <div className="relative overflow-hidden rounded-[2.35rem] bg-[#040816] p-2 sm:p-3 lg:p-4">
          ...
          <div className="relative overflow-hidden rounded-[1.9rem] border border-white/12 bg-slate-950/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
            <Image
              src="/images/adash-wallet-banner.png"
              alt="A'dash Wallet banner showing benefits for merchants, Slyders, and customers."
              width={1825}
              height={862}
              priority={false}
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs font-medium uppercase tracking-[0.2em] text-slate-400">Instant movement, cleaner payouts</span>
              </div>
              <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600 sm:text-[0.95rem]">
                A faster wallet experience for merchants, Slyders, and customers who want simpler payments, smoother cash flow, and better visibility across every transaction.
              </p>
            </div>
