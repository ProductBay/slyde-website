...
type SlyderLeadMessageActionsProps = {
  leadId: string;
  devAdminKey?: string;
};

export function SlyderLeadMessageActions({ leadId, devAdminKey }: SlyderLeadMessageActionsProps) {
  ...
  function resendEmail() {
    startTransition(async () => {
      setError(null);
      setMessage(null);
      const response = await fetch(`/api/admin/slyder-leads/${leadId}/resend-email`, { method: "POST", headers });
  ...
  function openWhatsapp() {
    startTransition(async () => {
      setError(null);
      setMessage(null);
      const response = await fetch(`/api/admin/slyder-leads/${leadId}/whatsapp-url`, { method: "POST", headers });
