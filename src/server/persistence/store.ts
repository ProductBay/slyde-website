  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "Additional parishes are being added as the network grows. If your parish is not listed, you are welcome to submit an application and SLYDE will notify you when your area opens.",
